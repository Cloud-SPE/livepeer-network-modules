...
func (e *Engine) openRecoveryRecord(req OpenRequest, id string, p *pb.SpendAuthorizationPayload, fp []byte) *sessionstore.Record {
	...
	return &sessionstore.Record{
		SessionID: id, GatewaySessionID: req.GatewaySessionID, WorkID: p.GetAuthorizationId(), Capability: req.Spec.Capability, Offering: req.Spec.Offering, BackendRef: req.Spec.BackendRef,
