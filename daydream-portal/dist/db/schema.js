...
export const waitlistStatus = ["pending", "approved", "rejected"];
export const waitlist = pgTable("daydream_waitlist", {
...
export const savedPrompts = pgTable("daydream_saved_prompts", {
    id: uuid("id").defaultRandom().primaryKey(),
...
export const usageEvents = pgTable("daydream_usage_events", {
    id: uuid("id").defaultRandom().primaryKey(),
    customerId: uuid("customer_id").notNull(),
    ...
    customerStartIdx: index("daydream_usage_events_customer_started_idx").on(t.customerId, t.startedAt),
    sessionIdx: uniqueIndex("daydream_usage_events_session_idx").on(t.sessionId),
}));
