...
// touches this portal.
import { z } from "zod";
import { closeSessionUsage, openSessionUsage, } from "../repo/usage.js";
...
export function registerSessionRoutes(app, deps) {
    ...
    app.post("/portal/sessions", { preHandler: requireCustomer }, async (req, reply) => {
    ...
    app.post("/portal/sessions/:id/close", { preHandler: requireCustomer }, async (req, reply) => {
