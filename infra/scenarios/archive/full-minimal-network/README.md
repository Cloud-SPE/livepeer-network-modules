...
```sh
cp infra/scenarios/archive/full-minimal-network/.env.example infra/scenarios/archive/full-minimal-network/.env
docker compose \
  -f infra/scenarios/archive/full-minimal-network/docker-compose.yml \
  --env-file infra/scenarios/archive/full-minimal-network/.env \
  up -d
```
