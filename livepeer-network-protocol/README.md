...
| [`protocols/`](./protocols/) | The two core protocols (`paid-job/v1`, `paid-session/v1`), their shared [wholesale account and spend-authorization contract](./protocols/wholesale-account.md), the runtime-descriptor framework, offering axes, runner attach, broker admin, and certification contracts |
