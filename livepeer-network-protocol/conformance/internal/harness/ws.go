...
// SendTopUp sends a session.topup frame carrying a required successor
// authorization, optional account funding, and its idempotency key.
func (w *WSConn) SendTopUp(requestID, authorization, payment string) error {
