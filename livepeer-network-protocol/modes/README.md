...
- [`live-session-gateway-ingest.md`](./live-session-gateway-ingest.md) — broker-owned live session authority with gateway-owned public RTMP ingest and runner-to-gateway object-storage HLS output. **Accepted 2026-05-20.**

**Status:** initial six plus two live-runner variants accepted. To propose
