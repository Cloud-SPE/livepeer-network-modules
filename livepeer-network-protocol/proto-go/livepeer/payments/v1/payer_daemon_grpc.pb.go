...
func (c *payerDaemonClient) ReportPaymentResult(ctx context.Context, in *ReportPaymentResultRequest, opts ...grpc.CallOption) (*ReportPaymentResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportPaymentResultResponse)
	err := c.cc.Invoke(ctx, PayerDaemon_ReportPaymentResult_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PayerDaemon_ReportPaymentResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportPaymentResultRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PayerDaemonServer).ReportPaymentResult(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PayerDaemon_ReportPaymentResult_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PayerDaemonServer).ReportPaymentResult(ctx, req.(*ReportPaymentResultRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PayerDaemon_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PayerDaemon_ReportPaymentResult_Handler,
		},
		{
