module github.com/Cloud-SPE/livepeer-network-modules/pool-payout-executor

go 1.25.7

// chain-commons is a sibling module in this monorepo, consumed via a
// relative replace (see protocol-daemon/go.mod for the same pattern).
