...
func parseFlags(args []string) (*config.Daemon, bool, error) {
	...
	fs.StringVar(&cfg.ServiceRegistryAddress, "service-registry-address", cfg.ServiceRegistryAddress, "registry contract address used by resolver GetServiceURI() lookups")
